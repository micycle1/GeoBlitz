 ...
 * @version 1.7
 */
public class FastMCIndexSegmentSetMutualIntersector implements SegmentSetMutualIntersector {
	/**
	 ...
	 */
	private HPRtreeX<MonotoneChain> index = new HPRtreeX<>();
	 ...
	 */
	public FastMCIndexSegmentSetMutualIntersector(Collection baseSegStrings) {
		initBaseSegments(baseSegStrings);
	}

	public FastMCIndexSegmentSetMutualIntersector(Collection baseSegStrings, Envelope env) {
		this.envelope = env;
		initBaseSegments(baseSegStrings);
	}

	public FastMCIndexSegmentSetMutualIntersector(Collection baseSegStrings, double overlapTolerance) {
		initBaseSegments(baseSegStrings);
	 ...
	 */
	public HPRtreeX<MonotoneChain> getIndex() {
		return index;
	}
